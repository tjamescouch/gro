...
export async function createMemory(cfg, driver, requestedMode, sessionId) {
 ...
 */
export function wrapWithSensory(inner, deps) {
    try {
...
export function unwrapMemory(mem) {
...
export function injectPlasticSourcePages(mem) {
...
export function saveSensorySnapshot(mem, sessionId) {
...
export function restoreSensorySnapshot(mem, sessionId) {
    if (!(mem instanceof SensoryMemory))
        return;
