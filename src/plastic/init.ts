...
export async function init(): Promise<void> {
  ...
  const sourceMapLines = [
    ...
    "2. **Write**: Use `write_source` tool (path relative to dist/, e.g. `version.js`), or shell commands (sed, cat). Both work — the export pipeline diffs the overlay against stock regardless of how changes were made.",
