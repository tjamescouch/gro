...
export function createDefaultFactory() {
    ...
    factory.register({ name: "context", maxTokens: 900, width: 82, height: 40, enabled: true, updateMode: "every_turn", viewable: true }, (deps) => new ContextMapSource(deps.memory, { maxChars: Math.floor(900 * 2.8), maxLines: 40 }));
    factory.register({ name: "time", maxTokens: 150, width: 82, height: 16, enabled: true, updateMode: "every_turn", viewable: true }, () => new TemporalSource());
    ...
    factory.register({ name: "self", maxTokens: 200, width: 82, height: 20, enabled: true, updateMode: "every_turn", viewable: true }, () => new SelfSource());
    return factory;
}
