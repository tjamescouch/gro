...
export function loadRuntimeBoot(): string {
...
export function assembleSystemPrompt(layers: BootLayers): string {
...
export function discoverExtensions(mcpConfigPaths: string[]): string[] {
